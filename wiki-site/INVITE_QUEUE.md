...
| Mary Harris | (handle not recorded yet) | — | — | — | skipped — owner decision, 2026-09-20. Not to be written unless the owner says so. The handle is missing here, so this row cannot be matched against the invite queue screen yet; it is written down so nobody writes the post in the meantime. |
