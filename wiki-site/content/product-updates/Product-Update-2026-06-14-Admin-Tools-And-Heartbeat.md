...
- **Chyme chat database optimization**: The presence heartbeat (the signal that keeps chat connected) now uses fewer database resources when idle, which cuts costs.
