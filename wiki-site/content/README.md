...
| `teaser` | The short standalone version of the post, aim for 280-500 characters. Shown on the feed page (`/feed`) and pasted as the platform post. It says what the post says, in 2-4 short sentences — a reader who never clicks through still got the idea. Not a cliffhanger. Posts without one fall back to `excerpt` on the feed. |
