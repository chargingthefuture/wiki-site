...
# How to sign up for the TI Skills Economy in ~5 minutes

1. Go to https://app.chargingthefuture.com and click "Create Account." You are asked for your email address

2. Receive a 6-digit code via email. Enter it into the website

3. Successfully complete step #2 and you are asked for your Quora handle/URL. The Quora URL is used as an initial litmus test if someone is a TI

4. Your sign up is reviewed, and typically the same day you can access all services
