...
The answer is a list. The Directory is a running list of Targeted Individuals alongside what they can do, at a public address, one person at a time and only if they want to be on it. It is the thing survivors ask for most, and it is not an account — the listing is the point, not a login behind it. Somebody who needs a repair can find the person who does repairs, and that is the whole mechanism.
