...
import { ensureMutationCsrf, requireFoundationReadAccess } from '@/src/app/api/foundation/_lib';
import { FOUNDATION_ERROR_CODE, FOUNDATION_QUOTE_STATES } from '@/src/lib/foundation/constants';
import { insertFoundationAudit, updateQuoteRequestState } from '@/src/lib/foundation/repository';
import type { FoundationQuoteState } from '@/src/lib/foundation/types';
