...
import { createSubmission, validateSubmissionInput } from '@/src/lib/skills-hunt/repository';
import type { SkillsHuntSubmissionInput } from '@/src/lib/skills-hunt/types';
